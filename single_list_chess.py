#Amanda Rismawati
#10109005
#Soal 4: Mendaftarkan peserta, menghapus peserta yang telah kalah, dan mencetak daftar peserta berdasarkan peringkat 

class Peserta:
    def _init_(self, nama, peringkat):
        self.nama = nama
...
while True:
    ...
    if pilihan == "1":
        ...
        turnament.daftar_peserta(nama, peringkat)
        print("Peserta terdaftar!")

    elif pilihan == "2":
        nama = input("Masukkan nama peserta yang kalah: ")
        turnament.hapus_peserta(nama)
        print("Peserta dihapus!")

    elif pilihan == "3":
        turnament.cetak_daftar_peserta()
