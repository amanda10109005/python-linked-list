#Amanda Rismawati
#10109005
#Soal 5 : Menambahkan produk baru, dan mencetak daftar produk beserta jumlah stock nya

class Produk:
    def _init_(self, nama, kode, stok):
        self.nama = nama
        self.kode = kode
        self.stok = stok
        self.next = None
...
while True:
    print("\nMenu:")
    print("1. Menambahkan produk ke inventaris")
    print("2. Menghapus produk dari inventaris")
    print("3. Mencetak daftar produk di inventaris")
    print("4. Keluar")
    ...
    if pilihan == "1":
        ...
        print("Produk selesai ditambahkan ke inventaris!")

    elif pilihan == "2":
        kode = input("Masukkan kode produk yang akan dihapus: ")
        inventaris.hapus_produk(kode)
        print("Produk telah dihapus dari inventaris!")
