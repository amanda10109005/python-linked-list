#Amanda RIsmawati
#10109005
#Soal 3: Menambahkan item ke dalam tas, menghapus item dan mencetak item berdasarkan tingkat kepentingan.
...
while True:
    print("\nMenu:")
    print("1. Menambahkan item ke dalam tas")
    print("2. Menghapus item dari tas")
    ...
    if pilihan == "1":
        ...
        print("Item selesai ditambahkan ke dalam tas!")

    elif pilihan == "2":
        nama = input("Masukkan nama item yang ingin dihapus: ")
        tas.hapus_item(nama)
        print("Item ini dihapus dari tas!")
