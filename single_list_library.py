#Amanda Rismawati
#10109005
#Soal 2 : Menctak daftar buku yang dipinjam oleh setiap pengunjung

class Buku:
    def _init_(self, judul):
        self.judul = judul
        self.next = None
...
class Pengunjung:
    ...
    def cetak_buku_dipinjam(self):
        if self.buku is None:
            ...
            print("{} telah meminjam buku dengan judul:".format(self.nama))
            buku_sekarang = self.buku
...
while True:
    ...
    if pilihan == "1":
        ...
        print("Peminjaman buku telag dicatat!")
        ...
        if nama in pengunjung:
            ...
            print("Pengunjung dengan atas nama tersebut tidak ditemukan.")
